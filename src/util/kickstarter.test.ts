...
describe('Kickstarter utility functions', () => {
  describe('isKickstarterUrl', () => {
    ...
    it('should return false for invalid Kickstarter URLs', () => {
      ...
      expect(isKickstarterUrl('https://www.kickstarter.com')).toBe(true)
      expect(isKickstarterUrl('https://kck.st')).toBe(true)
    })
  })

  describe('canonicalizeKickstarterUrl', () => {
    it('should return null for non-Kickstarter URLs', async () => {
      expect(await canonicalizeKickstarterUrl('https://www.google.com')).toBe(
        null,
      )
    })
    ...
    it('should return a canonical URL for valid Kickstarter URLs', async () => {
      expect(
        await canonicalizeKickstarterUrl(
          'https://www.kickstarter.com/projects/123456789/test-project',
        ),
